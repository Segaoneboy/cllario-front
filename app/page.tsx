        ...
        <main className="text-[#5170FF] bg-white min-h-screen flex flex-col items-center">
            ...
            <section className="mt-24 rounded-2xl p-8 max-w-4xl text-center mx-4">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                    Cllario — это веб-приложение для личностного самоанализа.
                    Оно объединяет психологические методики и искусственный интеллект,
                    чтобы помочь тебе понять, как ты принимаешь решения,
                    что тебя мотивирует и какие навыки ты можешь развить.
                </p>
            </section>
        </main>
    );
